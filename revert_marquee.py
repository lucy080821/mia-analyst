...
revert_dashboard(r'C:\Leo Harrison\Mia Analyst\templates\analytics\dashboard.html')
revert_dashboard(r'C:\Leo Harrison\Mia Analyst\templates\analytics\dashboard_en.html')
print("Reverted JS logic")
